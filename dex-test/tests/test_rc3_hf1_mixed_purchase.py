...
class MixedPurchaseMigrationTest(unittest.TestCase):
    def test_0015_preserves_confirmed_and_incomplete_rc3_rows_without_backfill(self):
        ...
        base_schema(db)
        self.assertEqual(apply_migrations(db, DEFAULT_MIGRATIONS[:-4])[-1], "0014_v22_phase7_sam_recognition")
        db.execute(
        ...
        self.assertEqual(apply_migrations(db), ("0015_v22_rc3_hf1_mixed_purchase_reconciliation", "0016_v23_inventory_intelligence_phase1_receipt_semantics", "0017_v24_sam_phase1_family_printing", "0018_v24_jarvis_economics_sam_phase2"))
