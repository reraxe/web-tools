...
Candidate: `DEX v2.3-test Inventory Intelligence Phase 1 Remediation 2`.

Suggested immutable image tag: `192.168.2.92:5000/apps/dex:v2.3-test-inventory-intelligence-phase1-remediation2`.

1. Open the accepted `DEX_v2.3-test_INVENTORY_INTELLIGENCE_PHASE1_REMEDIATION2_DEPLOY` package after it is separately approved and created.
...
13. Compare deployed runtime hashes for `/app/app.py`, `/app/static/index.html`, `/app/static/app.js`, and `/app/static/styles.css` with the accepted DEPLOY ledger.
