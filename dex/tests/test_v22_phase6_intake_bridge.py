...
class Phase6MigrationTest(unittest.TestCase):
    def test_migration_is_additive_and_does_not_backfill_historical_links(self):
        ...
        db.commit()
        self.assertEqual(apply_migrations(db, DEFAULT_MIGRATIONS[:-6]), ("0013_v22_phase6_downstream_intake_bridge",))
        ...
        self.assertEqual(apply_migrations(db), ("0014_v22_phase7_sam_recognition", "0015_v22_rc3_hf1_mixed_purchase_reconciliation", "0016_v23_inventory_intelligence_phase1_receipt_semantics", "0017_v24_sam_phase1_family_printing", "0018_v24_jarvis_economics_sam_phase2", "0019_v24_sam_multi_evidence_operator_trial_v1a"))
