...
assert(/org\.opencontainers\.image\.version="(?:v2\.3-test-inventory-intelligence-phase1-remediation(?:1|2|3)|v2\.4-test-(?:sam-phase1-family-printing|jarvis-sam-phase2|sam-multi-evidence-operator-trial-v1a)|v2\.4-live)"/.test(dockerfile));
